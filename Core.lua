...
core.EncounterList = {
  -- Event IDs must be in the exact same order as core.BossList declared in localization files
  MC = {
    663, 664, 665,
    666, 668, 667, 669,
    670, 671, 672
  ...
  ONYXIA = { 1084 },
  WORLD = {
    -- No encounter IDs have been identified for these world bosses yet
...
core.TableWidth, core.TableRowHeight, core.TableNumRows = 300, 18, 27; -- width, row height, number of rows
