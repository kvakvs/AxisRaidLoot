...
local function RightClickMenu(self)
  ...
  menu = {
      ...
      menuList = {
        {
          text = L["VIEWRAID"],
          notCheckable = true,
          keepShownOnClick = false; func = function()
    ...
    {
      text = L["VALIDATETABLES"],
      notCheckable = true,
      disabled = not core.IsOfficer,
      func = function()
  ...
  if #core.SelectedData < 2 then
    ...
    menu[2] = {
      text = L["INVITE"] .. " " .. core.WorkingTable[self.index].player .. " " .. L["TORAID"],
      notCheckable = true,
      func = function()
    ...
    if StandbySearch then
      menu[10].menuList = {
        {
          text = L["REMOVE"] .. " " .. core.WorkingTable[self.index].player .. " " .. L["FROMSTANDBYLIST"],
          notCheckable = true,
          func = function()
            EditStandbyList(self.index, "remove")
            ToggleDropDownMenu(nil, nil, menuFrame)
      ...
      menu[10].menuList = {
        {
          text = L["ADD"] .. " " .. core.WorkingTable[self.index].player .. " " .. L["TOSTANDBYLIST"],
          notCheckable = true,
          func = function()
            EditStandbyList(self.index, "add")
            ToggleDropDownMenu(nil, nil, menuFrame)
  ...
  for i = 1, #core.classes do -- create Filter selections in context menu
    menu[7].menuList[i] = {
      text = core.LocalClass[core.classes[i]],
      isNotRadio = true,
      keepShownOnClick = true,
      checked = MonDKP.ConfigTab1.checkBtn[i]:GetChecked(),
      func = function()
  ...
  menu[7].menuList[#core.classes + 1] = {
    text = L["ALLCLASSES"],
    isNotRadio = true,
  ...
  menu[7].menuList[#core.classes + 2] = {
  ...
  menu[7].menuList[#core.classes + 3] = {
    text = L["ONLINE"],
    isNotRadio = true,
    keepShownOnClick = true,
    checked = MonDKP.ConfigTab1.checkBtn[11]:GetChecked(),
    func = function()
  ...
  menu[7].menuList[#core.classes + 4] = {
  ...
  menu[11].menuList[#menu[11].menuList + 1] = {
    text = L["CLOSE"],
    notCheckable = true,
    func = function()
      ToggleDropDownMenu(nil, nil, menuFrame)
  ...
  for i = 1, core.TableNumRows do -- show rows if they have values
    ...
    if core.WorkingTable[index] then
      ...
      if (CheckAdjusted > 0) then
        ...
        row.DKPInfo[3].adjustedArrow:SetTexture("Interface\\AddOns\\AxisRaidLoot\\Media\\Textures\\green-up-arrow.png");
      elseif (CheckAdjusted < 0) then
        row.DKPInfo[3].adjustedArrow:SetTexture("Interface\\AddOns\\AxisRaidLoot\\Media\\Textures\\red-down-arrow.png");
      else
      ...
      if not a then
        ...
        MonDKP.DKPTable.Rows[i]:SetNormalTexture("Interface\\AddOns\\AxisRaidLoot\\Media\\Textures\\ListBox-Highlight")
